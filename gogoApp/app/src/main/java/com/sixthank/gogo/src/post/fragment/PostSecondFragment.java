...
public class PostSecondFragment extends BaseFragment<FragmentPostSecondBinding> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.postSecondImgPicture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                binding.postSecondRvColor.setVisibility(View.GONE);
                binding.postSecondRvTxt.setVisibility(View.GONE);
                v.setSelected(true);
            }
        });
        binding.postSecondImgDraw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                binding.postSecondRvColor.setVisibility(View.VISIBLE);
                binding.postSecondRvTxt.setVisibility(View.GONE);
            }
        });
        binding.postSecondImgTxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                binding.postSecondRvColor.setVisibility(View.GONE);
